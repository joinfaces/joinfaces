...
The latest copy of the user gude is available at https://docs.joinfaces.org/current/reference +
...
https://docs.spring.io/spring-boot/docs/{spring-boot-version}/reference/htmlsingle/#getting-started-system-requirements[_Spring Boot_].
