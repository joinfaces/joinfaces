...
They can be found https://docs.spring.io/spring-boot/docs/{spring-boot-version}/reference/html/appendix.html#common-application-properties[in
...
The can be found in
https://docs.spring.io/spring-boot/docs/{spring-boot-version}/reference/html/appendix.html#appendix-dependency-versions[the
