...
public class MyfacesProperties {
	 ...
	 * the webapp.
	 */
	@InitParameter(AbstractFacesInitializer.INIT_PARAM_LOG_WEB_CONTEXT_PARAMS)
	 ...
	 */
	@InitParameter(PREFFIX + "ENUM_CONVERTER_ALLOW_STRING_PASSTROUGH")
	private Boolean enumConverterAllowStringPasstrough;

	/**
	 * Deprecated: use JSF 2.0 ExceptionHandler.
	 */
	@InitParameter(PREFFIX + "ERROR_HANDLER")
	 ...
	 * not.
	 */
	@InitParameter(PREFFIX + "CHECKED_VIEWID_CACHE_SIZE")
	 ...
	 */
	@InitParameter(PREFFIX + "CHECKED_VIEWID_CACHE_ENABLED")
	 ...
	 * readable".
	 */
	@InitParameter(PREFFIX + "PRETTY_HTML")
	 ...
	 */
	@InitParameter(PREFFIX + "RENDER_CLEAR_JAVASCRIPT_FOR_BUTTON")
	 ...
	 * them.
	 */
	@InitParameter(PREFFIX + "RENDER_HIDDEN_FIELDS_FOR_LINK_PARAMS")
	private Boolean renderHiddenFieldsForLinkParams;

	/**
	 * Add a code that save the form before submit using a link.
	 */
	@InitParameter(PREFFIX + "SAVE_FORM_SUBMIT_LINK_IE")
	 ...
	 */
	@InitParameter(PREFFIX + "DELEGATE_FACES_SERVLET")
	 ...
	 */
	@InitParameter(FaceletViewDeclarationLanguage.REFRESH_TRANSIENT_BUILD_ON_PSS)
	 ...
	 * src=ELExpression.
	 */
	@InitParameter(PREFFIX + "REFRESH_TRANSIENT_BUILD_ON_PSS_PRESERVE_STATE")
	 ...
	 */
	@InitParameter(PREFFIX + "VALIDATE_XML")
	 ...
	 * value).
	 */
	@InitParameter(PREFFIX + "DEBUG_PHASE_LISTENER")
	 ...
	 */
	@InitParameter(PREFFIX + "STRICT_JSF_2_REFRESH_TARGET_AJAX")
	 ...
	 */
	@InitParameter(PREFFIX + "STRICT_JSF_2_CC_EL_RESOLVER")
	 ...
	 */
	@InitParameter(PREFFIX + "DEFAULT_RESPONSE_WRITER_CONTENT_TYPE_MODE")
	 ...
	 */
	@InitParameter(PREFFIX + "VIEW_UNIQUE_IDS_CACHE_ENABLED")
	 ...
	 */
	@InitParameter(PREFFIX + "COMPONENT_UNIQUE_IDS_CACHE_SIZE")
	 ...
	 * is true.
	 */
	@InitParameter(PREFFIX + "SUPPORT_JSP_AND_FACES_EL")
	 ...
	 */
	@InitParameter(PREFFIX + "GAE_JSF_JAR_FILES")
	 ...
	 */
	@InitParameter(PREFFIX + "GAE_JSF_ANNOTATIONS_JAR_FILES")
	 ...
	 */
	@InitParameter(PREFFIX + "STRICT_JSF_2_VIEW_NOT_FOUND")
	 ...
	 */
	@InitParameter(PREFFIX + "STRICT_JSF_2_FACELETS_COMPATIBILITY")
	 ...
	 */
	@InitParameter(PREFFIX + "RENDER_FORM_VIEW_STATE_AT_BEGIN")
	 ...
	 * to the response.
	 */
	@InitParameter(PREFFIX + "FLASH_SCOPE_DISABLED")
	 ...
	 * session.
	 */
	@InitParameter(PREFFIX + "NUMBER_OF_VIEWS_IN_SESSION")
	 ...
	 */
	@InitParameter(PREFFIX + "NUMBER_OF_SEQUENTIAL_VIEWS_IN_SESSION")
	private Integer numberOfSequentialViewsInSession;

	/**
	 * Indicate the max number of flash tokens stored into session.
	 */
	@InitParameter(PREFFIX + "NUMBER_OF_FLASH_TOKENS_IN_SESSION")
	 ...
	 * flow.
	 */
	@InitParameter(PREFFIX + "FACES_FLOW_CLIENT_WINDOW_IDS_IN_SESSION")
	 ...
	 * supported.
	 */
	@InitParameter(PREFFIX + "SUPPORT_EL_3_IMPORT_HANDLER")
	 ...
	 */
	@InitParameter(PREFFIX + "SERIAL_FACTORY")
	 ...
	 */
	@InitParameter(PREFFIX + "COMPRESS_STATE_IN_CLIENT")
	 ...
	 */
	@InitParameter(PREFFIX + "MAC_ALGORITHM")
	 ...
	 */
	@InitParameter(StateCache.RANDOM_KEY_IN_CSRF_SESSION_TOKEN_SECURE_RANDOM_PROVIDER_PARAM)
	 ...
	 */
	@InitParameter(StateCache.RANDOM_KEY_IN_CSRF_SESSION_TOKEN_SECURE_RANDOM_ALGORITM_PARAM)
	 ...
	 */
	@InitParameter(PREFFIX + "COMPRESS_STATE_IN_SESSION")
	private Boolean compressStateInSession;

	/**
	 * This parameter has been removed from 2.
	 */
	@InitParameter(PREFFIX + "CACHE_OLD_VIEWS_IN_SESSION_MODE")
	 ...
	 */
	@InitParameter(PREFFIX + "USE_FLASH_SCOPE_PURGE_VIEWS_IN_SESSION")
	private Boolean useFlashScopePurgeViewsInSession;

	/**
	 * Adds a random key to the generated view state session token.
	 */
	@InitParameter(PREFFIX + "RANDOM_KEY_IN_VIEW_STATE_SESSION_TOKEN")
	 ...
	 * token.
	 */
	@InitParameter(PREFFIX + "RANDOM_KEY_IN_VIEW_STATE_SESSION_TOKEN_LENGTH")
	private Integer randomKeyInViewStateSessionTokenLength;

	/**
	 * Sets the random class to initialize the secure random id generator.
	 */
	@InitParameter(PREFFIX + "RANDOM_KEY_IN_VIEW_STATE_SESSION_TOKEN_SECURE_RANDOM_CLASS")
	private String randomKeyInViewStateSessionTokenSecureRandomClass;

	/**
	 * Sets the random provider to initialize the secure random id generator.
	 */
	@InitParameter(PREFFIX + "RANDOM_KEY_IN_VIEW_STATE_SESSION_TOKEN_SECURE_RANDOM_PROVIDER")
	private String randomKeyInViewStateSessionTokenSecureRandomProvider;

	/**
	 * Sets the random algorithm to initialize the secure random id generator.
	 */
	@InitParameter(PREFFIX + "RANDOM_KEY_IN_VIEW_STATE_SESSION_TOKEN_SECURE_RANDOM_ALGORITM")
	 ...
	 */
	@InitParameter(FacesConfigValidator.VALIDATE_CONTEXT_PARAM)
	 ...
	 */
	@InitParameter(PREFFIX + "INITIALIZE_SKIP_JAR_FACES_CONFIG_SCAN")
	private Boolean initializeSkipJarFacesConfigScan;

	/**
	 * The Class of an Comparator<ELResolver/> implementation.
	 */
	@InitParameter(ResolverBuilderBase.EL_RESOLVER_COMPARATOR)
	 ...
	 */
	@InitParameter(ResolverBuilderBase.EL_RESOLVER_PREDICATE)
	private Class<? extends Predicate> elResolverPredicate;

	/**
	 * no description.
	 */
	@InitParameter(ClientWindowFactoryImpl.INIT_PARAM_DEFAULT_WINDOW_MODE)
	 ...
	 */
	@InitParameter(PREFFIX + "ERROR_TEMPLATE_RESOURCE")
	 ...
	 * ui:debug tag).
	 */
	@InitParameter(PREFFIX + "DEBUG_TEMPLATE_RESOURCE")
	private String debugTemplateResource;

	/**
	 * Indicate if myfaces is responsible to handle errors.
	 */
	@InitParameter(ErrorPageWriter.ERROR_HANDLING_PARAMETER)
	 ...
	 */
	@InitParameter(HtmlResponseStateManager.INIT_PARAM_HANDLE_STATE_CACHING_MECHANICS)
	private Boolean handleStateCachingMechanics;

	/**
	 * Add autocomplete="off" to the view state hidden field.
	 */
	@InitParameter(HtmlResponseStateManager.INIT_PARAM_AUTOCOMPLETE_OFF_VIEW_STATE)
	 ...
	 */
	@InitParameter(InternalClassLoaderResourceLoader.USE_MULTIPLE_JS_FILES_FOR_JSF_UNCOMPRESSED_JS)
	private Boolean useMultipleJsFilesForJsfUncompressedJs;

	/**
	 * Define the mode used for jsf.
	 */
	@InitParameter(InternalClassLoaderResourceLoader.MYFACES_JSF_MODE)
	 ...
	 */
	@InitParameter(DefaultFaceletsStateManagementStrategy.SAVE_STATE_WITH_VISIT_TREE_ON_PSS)
	 ...
	 */
	@InitParameter(DefaultFaceletsStateManagementStrategy.CHECK_ID_PRODUCTION_MODE)
	private String checkIdProductionMode;

	/**
	 * no description.
	 */
	@InitParameter(PREFFIX + "MARK_INITIAL_STATE_WHEN_APPLY_BUILD_VIEW")
	 ...
	 * memory.
	 */
	@InitParameter(ViewPool.INIT_PARAM_VIEW_POOL_ENTRY_MODE)
	 ...
	 */
	@InitParameter(ViewPool.INIT_PARAM_VIEW_POOL_DEFERRED_NAVIGATION)
	 ...
	 */
	@InitParameter(PREFFIX + "EXPRESSION_FACTORY")
	 ...
	 */
	@InitParameter(value = PREFFIX + "FACES_INIT_PLUGINS", listSeparator = ",")
	...
	public static class Annotation {
		 ...
		 * startup performance.
		 */
		@InitParameter(CdiAnnotationProviderExtension.USE_CDI_FOR_ANNOTATION_SCANNING)
		 ...
		 */
		@InitParameter(DefaultAnnotationProvider.SCAN_PACKAGES)
	...
	public static class Spi {
		 ...
		 * no description.
		 */
		@InitParameter(PREFFIX + "spi.InjectionProvider")
	...
	public static class Validator {
		 ...
		 */
		@InitParameter(PREFFIX + "validator.BEAN_BEFORE_JSF_VALIDATION")
